...
class Model(Acess):
    ...
    def inset_features(self, data):
        # {% builder start insert_features %}
        data['40'] = ft.feature40(data['retorno'])
        data['21'] = ft.feature21(data['retorno'])
        data['24'] = ft.feature24(data['retorno'])
        data['28'] = ft.feature28(data['retorno'])
        data['104'] = ft.feature104(data['retorno'])    
        data['101'] = ft.feature101(data['retorno'])
        return data
